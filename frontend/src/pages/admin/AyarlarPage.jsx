  ...
  return (
    <div className="p-4 sm:p-6 space-y-3 max-w-2xl">
      ...
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-base font-black text-gray-900">Ayarlar</h1>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="flex items-center gap-1.5 px-3 py-2.5 border-b border-gray-100">
            ...
            <p className="text-xs font-bold text-gray-700">E-posta Değiştir</p>
          </div>
          <form onSubmit={handleEmailGuncelle} className="p-3 space-y-2">
            <div>
              <label className="text-[10px] font-semibold text-gray-400 mb-1 block">Mevcut</label>
              <div className="px-2.5 py-1.5 rounded-lg bg-gray-50 text-xs text-gray-400 border border-gray-100 truncate">
                {kullanici?.email || '—'}
              </div>
            </div>
            <div>
              <label className="text-[10px] font-semibold text-gray-400 mb-1 block">Yeni E-posta</label>
              <input
                type="email"
                value={email}
            ...
            <button type="submit" disabled={emailYukleniyor || !email.trim()}
              ...
              {emailYukleniyor
                ...
                : <><Check className="w-3 h-3" /> Güncelle</>
              }
            </button>
          </form>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="flex items-center gap-1.5 px-3 py-2.5 border-b border-gray-100">
            ...
            <p className="text-xs font-bold text-gray-700">Şifre Değiştir</p>
          </div>
      ...
      <p className="text-center text-xs text-gray-300 pb-1">StokSay v2.0.0</p>
    </div>
  );
}
