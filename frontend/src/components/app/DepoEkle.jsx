...
export default function DepoEkle({ isletmeler = [], isletmeId, onKapat, onKaydedildi }) {
  const [seciliIsletmeId, setSeciliIsletmeId] = useState(isletmeId || isletmeler[0]?.id || null);
          ...
          <div>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold" style={{ color: seciliIsletme ? '#1F2937' : '#9CA3AF' }}>
