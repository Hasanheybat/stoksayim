...
const translations = {
  ...
  'businesses.subtitle': {
    tr: 'İşletme yönetimi',
    az: 'Müəssisə idarəetməsi',
    ru: 'Управление предприятиями',
  },
  'warehouses.subtitle': {
    tr: 'Depo yönetimi',
    az: 'Anbar idarəetməsi',
    ru: 'Управление складами',
  },
  'users.subtitle': {
    tr: 'Kullanıcı yönetimi',
  ...
  'products.subtitle': {
    tr: 'Ürün yönetimi',
    az: 'Məhsul idarəetməsi',
    ru: 'Управление товарами',
  },

  // ══════════════════════════════════════
  // NAV BÖLÜM BAŞLIKLARI
  // ══════════════════════════════════════
  'nav.mainMenu': {
    tr: 'ANA MENÜ',
    az: 'ƏSA MENYU',
  ...
  'dashboard.noCountsYet': {
    tr: 'Henüz sayım yok',
    az: 'Hələ sayım yoxdur',
    ru: 'Пока нет подсчётов',
  },
  ...
  'roles.subtitle': {
    tr: 'Rol ve yetki yönetimi',
    az: 'Rol və icazə idarəetməsi',
    ru: 'Управление ролями',
  },
  'roles.newRole': {
    tr: 'Yeni Rol',
  ...
  'roles.noRoles': {
    tr: 'Henüz rol bulunmuyor',
    az: 'Hələ rol tapılmadı',
    ru: 'Ролей пока нет',
  },
  'roles.assignedUsers': {
    tr: 'Atanmış Kullanıcılar',
    az: 'Təyin olunmuş istifadəçilər',
    ru: 'Назначенные пользователи',
  },
  'roles.assignRole': {
    tr: 'Yeni Rol Ata',
    az: 'Yeni rol təyin et',
    ru: 'Назначить роль',
  },
  'roles.selectRole': {
    tr: 'Rol seçin...',
  ...
  'counts.subtitle': {
    tr: 'Envanter sayım yönetimi',
    az: 'İnventar sayım idarəetməsi',
    ru: 'Управление подсчётами',
  },
  'counts.searchPlaceholder': {
    tr: 'Sayım ara...',
    az: 'Sayım axtar...',
    ru: 'Поиск подсчёта...',
  },
  ...
  'mergedCounts.searchPlaceholder': {
    tr: 'Sayım adı ara...',
    az: 'Sayım adı axtar...',
  ...
  'mergedCounts.sourceDetails': {
    tr: 'Kaynak Detayları',
    az: 'Mənbə Təfərrüatları',
    ru: 'Детали источника',
  },
  'mergedCounts.sourceCounts': {
    tr: 'Kaynak Sayımlar',
    az: 'Mənbə Sayımlar',
    ru: 'Исходные подсчёты',
  },
  'mergedCounts.editTitle': {
    tr: 'Sayımı Düzenle',
    az: 'Sayımı redaktə et',
    ru: 'Редактировать подсчёт',
  },
  ...
  'mergedCounts.deleteConfirm': {
    tr: 'Bu sayım silinecek. Devam etmek istiyor musunuz?',
    az: 'Bu sayım silinəcək. Davam etmək istəyirsiniz?',
    ru: 'Этот подсчёт будет удалён. Продолжить?',
  },
